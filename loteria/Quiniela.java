...
public class Quiniela {
	...
	// Zenbaki oso positibo bat eskatu eta jasotzen du pantailatik
	// ===========================================================================================================
	static int EskatuZenbakiOsoPositiboa(String usuarioariEskaera) {
		Scanner sn = new Scanner(System.in);
		int golKopurua = 0;
		boolean sarreraEgokia = false;

		while (!sarreraEgokia) {
			System.out.println(usuarioariEskaera);
			try {
				golKopurua = sn.nextInt(); // intentamos leer un número
				if (golKopurua >= 0) {
	...
	void QuinielaApustuaEskatu() {
		...
		for (i = 0; i < apustua15.length; i++) {
			...
			apustua15[i] = EskatuZenbakiOsoPositiboa(usuarioariEskaera);
		}
	...
	// 2.- Ausazko quiniela emaitzak sortu
	// ===========================================================================================================
	void AusazkoQuinielaEmaitzakSortu() {
	...
	// 3.-Usuarioaren apustua ausaz sortutako emaitzekin konparatu
	// ===========================================================================================================
	void QuinielaApustuaEmaitzekinKonparatu() {
	...
	// 4.- Emaitzak bistaratu
	// ===========================================================================================================
	void QuinielanAsmatutakoakBistaratu() {
	...
	// Quiniela aplikazio nagusia
	// ===========================================================================================================
	public void QuinielaExekutatu() {

		// Quiniela apustua eskatu
		QuinielaApustuaEskatu();

		// Ausaz quinielaren emaitzak sortu
		AusazkoQuinielaEmaitzakSortu();

		// Usuarioak emandako apustua emaitzarekin konparatu
		QuinielaApustuaEmaitzekinKonparatu();

		// Emaitzak bistaratu
		QuinielanAsmatutakoakBistaratu();
	}
	// ===========================================================================================================
